package com.valenpatel.bmicalculator.activities
...
import com.valenpatel.bmicalculator.databinding.ActivityMainBinding
import com.valenpatel.bmicalculator.fragments.AddValuesFragment
import com.valenpatel.bmicalculator.fragments.ResultsFragment
import com.valenpatel.bmicalculator.fragments.SplashFragment
...
class MainActivity : AppCompatActivity() {
    ...
    fun setFragment(fragment: Fragment) {
        supportFragmentManager.beginTransaction().replace(frameLayout.getId(), fragment).commitAllowingStateLoss()
    }
