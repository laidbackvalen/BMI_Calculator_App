...
import com.valenpatel.bmicalculator.databinding.FragmentSelectGenderBinding
...
//            (activity as MainActivity).onBackPressed()
        ...
        selectGenderBinding.moreImageView.setOnClickListener {
            (activity as MainActivity).setFragment(MoreFragment())
        }
